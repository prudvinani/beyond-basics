...
export default function MainCodeofAnimation() {
  ...
  <p className="text-4xl mt-1"> with the <span className="font-semibold">skills of tomorrow?</span></p>
    ...
    <p className="font-inter text-4xl tracking-tight">Not sure where to </p>
      ...
      <p  className="text-2xl font-sans tracking-tight ">We guide you with step-by-step structured <br/>learning&#44; hands-on tasks&#44; and expert mentorship <br/> so you gain practical experience. Plus you&#39;ll be <br/> part of a supportive community that helps you <br/> discover new opportunities and grow with <br/>
      confidence.
      </p>
      </section> 

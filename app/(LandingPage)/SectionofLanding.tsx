...
export const SectionofLanding = () => {
  return (
    <div className="flex flex-col  md:gap-y-14 lg:gap-y-16 -mt-5 md:-mt-28">
      ...
      {/** Section 1 */}
      <section 
        className="bg-[#09d85f] font-outfit tracking-tight mx-5 text-white flex flex-col md:flex-row justify-between items-center md:items-start py-16 px-6 md:px-10 md:mx-32 rounded-3xl sticky md:static"
        style={{ top: "80px" }} // Mobile stacking effect
      >
      ...
      {/** Section 2 */}
      <section 
        className="bg-[#966fd6] tracking-wide font-outfit text-white flex flex-col mx-5 md:flex-row justify-between items-center md:items-start py-16 px-6 md:px-10 md:mx-32 rounded-3xl sticky md:static"
        style={{ top: "160px" }} // Mobile stacking effect
      >
        <div className="text-center md:text-left">
      ...
      {/** Section 3 */}
      <section 
        className="bg-[#427977] text-white flex flex-col mx-5 md:flex-row justify-between items-center md:items-start py-16 px-6 md:px-10 md:mx-32 rounded-3xl sticky md:static"
        style={{ top: "240px" }} // Mobile stacking effect
      >
        <div className="text-center md:text-left">

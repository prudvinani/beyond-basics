      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col items-center">
          <div className="flex items-center gap-2 mb-4 sm:mb-6">
            <svg
              className="w-5 h-5 sm:w-6 sm:h-6 text-[#09D85F]"
              viewBox="0 0 24 24"
              fill="#7C3AED"
            >
            ...
            <span className="text-sm sm:text-[15px] text-white ">
              © Beyond Basics, 2025. All rights reserved
            </span>
          </div>
          ...
          <div className="mb-4 sm:mb-6 text-sm sm:text-[15px] text-white text-center">
            ...
            <Link
              href="#"
              className="text-white underline ml-1 hover:text-[#09D85F] transition-colors"
            >
              Beyond Basics
            </Link>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center gap-3 sm:gap-4  ">
            <Link
              href="#"
              className="text-sm sm:text-[15px] hover:underline cursor-pointer transition-colors"
            >
            ...
            <Link
              href="#"
              className="text-sm sm:text-[15px] hover: cursor-pointer hover:underline transition-colors"
            >
          ...
          <div className="flex items-center gap-4 mt-6 sm:mt-8 sm:absolute sm:right-8 pb-8 ">
            <Link
              href="https://www.linkedin.com/company/codedale/"
              target="_blank"
            ...
            <Link
              href="https://www.instagram.com/beyondbasics.dev/"
              target="_blank"

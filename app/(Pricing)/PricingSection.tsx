...
export default function PricingSection() {
  const [billingPeriod, setBillingPeriod] = useState<"monthly" | "sixMonth">(
    "monthly"
  );
  ...
  return (
    <div className="min-h-screen w-full bg-[#12100E] text-white flex flex-col items-center py-16 px-4 ">
      ...
      <p className="text-center max-w-2xl text-lg mb-12">
        Unlock resources, network with experts, and accelerate your journey
        whether you&apos;re just starting or ready to go pro!
      </p>
